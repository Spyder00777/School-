...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while len(currentPlace.bees) < 1:
            ...
            counter += 1
        if (currentPlace is not hive) and (counter < self.r_max and counter > self.r_min):         
...
class HungryAnt(Ant):
    """HungryAnt willa take three turns to digest a Bee in its place.
